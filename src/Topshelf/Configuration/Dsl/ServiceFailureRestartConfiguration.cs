...
namespace Topshelf.Configuration.Dsl
{
	...
	public class ServiceFailureRestartConfiguration :
		IServiceFailureRestartConfiguration
	{
		readonly ServiceRecoveryOptions _serviceRecoveryOptions;

		public ServiceFailureRestartConfiguration(ServiceRecoveryOptions serviceRecoveryOptions)
		{
