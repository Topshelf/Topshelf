...
namespace Topshelf.HostConfigurators
{
		...
		Configurator
	{
		...
		/// <summary>
		/// Specifies the ability of the service to pause and continue when registered
		/// </summary>
		/// <param name="canPauseandContinue"></param>
		void SetPausable(bool canPauseandContinue);
