...
{
	public class RestartServiceConfiguratorImpl :
		RestartServiceConfigurator
	{
		readonly RecoveryHostConfigurator _configurator;

		public RestartServiceConfiguratorImpl(RecoveryHostConfigurator configurator)
		{
		...
		public RestartServiceConfigurator Wait(int minutes)
		{
			_configurator.SetComputerRestartDelay(minutes);
