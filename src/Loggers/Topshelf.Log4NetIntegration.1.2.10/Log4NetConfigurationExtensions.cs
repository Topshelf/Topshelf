...
namespace Topshelf
{
    ...
    public static class Log4NetConfigurationExtensions
    {
        ...
        public static void UseLog4Net([CanBeNull] this HostConfigurator configurator)
        {
            Log4NetLogger.Use();
        }
        ...
        public static void UseLog4Net([NotNull] this HostConfigurator configurator, string configFileName)
        {
            Log4NetLogger.Use(configFileName);
        }
    }
}